...
/**
 * A simple hash function class that supports convert string or int to hash_t.
 */
class SimpleHashFunction {
 public:
  ...
  // calculate the hash for an integer type value
  // refer from
...
class HashJoinExecutor : public AbstractExecutor {
 public:
   ...
   */
  HashJoinExecutor(AbstractExecutor *left_child_executor, AbstractExecutor *right_child_executor, SimpleHashFunction *hash_fn);
